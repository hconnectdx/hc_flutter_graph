      ...
      body: Padding(
        ...
        child: GaugeChart(
          ...
          segments: [
            ...
            GaugeSegment(startValue: 50, endValue: 100, color: Colors.green),
            GaugeSegment(startValue: 100, endValue: 150, color: Colors.lime),
            GaugeSegment(startValue: 150, endValue: 200, color: Colors.amber),
            GaugeSegment(startValue: 200, endValue: 250, color: Colors.orange),
